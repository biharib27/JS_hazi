...
function szinez() {
    ...
    //Lekérjük az <li> elemeket az <ol> alatt
    var div = document.getElementById("DIV_generalt_lista");
    var ol = div.getElementsByTagName("ol")[0];
    if (!ol) return; // ha nincs lista, kilép

    var li = ol.getElementsByTagName("li");
    var darab = li.length;

    //Végigmegyünk minden elemén és a listában megadott színűre állítjuk a backgroundColor-t
    for (var i = 0; i < darab; i++) {
        // i+1 = a lista sorszáma 1-től
